  ...
  router.route('/entity/filter')
    .get((req, res, next) => {
      try {
        ...
        countQuery.tenantId=header.tenantid;
        countQuery.accessLevel=header.accesslevel;
        countQuery.entityId=header.entityid;
        ...
        filterQuery.tenantId=header.tenantid;
        filterQuery.accessLevel=header.accesslevel;
        filterQuery.entityId=header.entityid;
